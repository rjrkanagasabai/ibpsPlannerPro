        ...
        style={{
          ...
          background:
            type === "syn"
              ? "rgba(16, 185, 129, 0.1)"
              : "rgba(239, 68, 68, 0.1)",
          color: type === "syn" ? "#10b981" : "#ef4444",
          border: `1px solid ${type === "syn" ? "rgba(16, 185, 129, 0.2)" : "rgba(239, 68, 68, 0.2)"}`,
        }}
      >
        {w}
      </span>
    ...
    <div>
      ...
      {searchResult && (
        <motion.div
          ...
          className="card vocab-flashcard"
          style={{
            marginBottom: "32px",
            borderTop: "4px solid var(--accent)",
            padding: "32px",
        ...
        >
          ...
          >
            ...
            >
              <strong style={{ color: "var(--text-muted)" }}>Meaning: </strong>
              <span style={{ fontFamily: "serif", fontSize: "18px" }}>
            ...
            >
              {searchResult.synonyms && (
                <div>
                  ...
                  <div>{renderPills(searchResult.synonyms, "syn")}</div>
                </div>
              )}
              {searchResult.antonyms && (
                <div>
                  ...
                  <div>{renderPills(searchResult.antonyms, "ant")}</div>
                </div>
              )}
            </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  flexDirection: "column",
                  padding: "24px",
                  borderTop: `4px solid ${isBookmarked ? "var(--warning)" : "transparent"}`,
                }}
              >
                <div
                  style={{
                ...
                >
                  ...
                  {(item.synonyms || item.antonyms) && (
                    <div>
                      ...
                      {item.antonyms && (
                        <div>{renderPills(item.antonyms, "ant")}</div>
                      )}
                    </div>
                  )}
...
// --- MODERN HABIT HEATMAP TRACKER VIEW (PERFECT ALIGNMENT) ---
...
// --- MODERN MOCK TEST TRACKER VIEW (NO STATS BAR) ---
  ...
  return (
    <div className="card" style={{ maxWidth: 600 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        {/* User Account Info - Aligned exactly as requested */}
        <div
